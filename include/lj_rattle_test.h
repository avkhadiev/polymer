...
*/
#ifndef LJ_RATTLE_TEST_H
#define LJ_RATTLE_TEST_H
#include <map>
...
extern const std::string neg_constraint_virial_str;
...
extern const std::string neg_constraint_virial_axis_str;
// observable units
extern const std::string units_energy;
// container classs
class LJRattleTestContainer :
...
private:
    ...
    ScalarObservable _neg_constraint_virial;
public:
    // a constructor and a destructor
    LJRattleTestContainer();
    ~LJRattleTestContainer();
};
// state for the simulation
extern double atomic_mass;
// simulation class
class LJRattleTestSimulation :
    public Simulation {
public:
    ...
    LJRattleTestSimulation(std::string name,
        std::string outdir,
        Integrator &integrator,
        ObservableContainer &observables);
    ~LJRattleTestSimulation();
};
#endif
